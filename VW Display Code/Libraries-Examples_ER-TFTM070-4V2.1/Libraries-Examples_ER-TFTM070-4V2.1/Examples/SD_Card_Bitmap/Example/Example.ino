...
long intervalDelay = 2000;  //Print and run program every 2seconds
...
// -------------------------------------------------------------
  ...
  Serial.println("OK!"); 
   ...
   //This is a delay function without using delay()
...
//Count up and down from 0 to 1500
   tmr = tmr + tmrAmount;
   if (tmr == 0 || tmr == 1500)
     tmrAmount = -tmrAmount;
//*******************************************

//Distance between the drawn lines
   i = tmr/10 + 20;

//Formulas to set the color    
   if (tmr >= 0)
   {
     myGLCD.setColor(255,165,0);  //Orange
     
     if (tmr >= 800)
     {
       myGLCD.setColor(0,255,0);    //Green
       
       if (tmr > 1000 && tmr <=1500)
       {     
   ...
   myGLCD.drawLine(50,i,269,i);      //Draw line
   myGLCD.drawLine(50,i+1,269,i+1);  //Draw double line
   myGLCD.drawLine(50,i+2,269,i+2);  //Draw triple line
