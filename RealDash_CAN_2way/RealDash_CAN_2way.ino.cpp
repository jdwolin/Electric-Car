# 1 "c:\\users\\jasonw~1\\appdata\\local\\temp\\tmpsgk5ld"
#include <Arduino.h>
...
void setbmslevel();
void keepme();
#line 70 "C:/Users/Jason Wolin/Dropbox/My Hobbies/Electric Car/RealDash_CAN_2way/RealDash_CAN_2way.ino"
void setup()
{
delay(5000);
M5.begin();
...
void SendCanBGS1_Cmd(unsigned int volts, unsigned int amps)
{
  ...
  stmp[6]=0;
  stmp[7]=0;
# 602 "C:/Users/Jason Wolin/Dropbox/My Hobbies/Electric Car/RealDash_CAN_2way/RealDash_CAN_2way.ino"
...
void SendCanVCU_Cmd(unsigned int volts, unsigned int amps)
{
      ...
      stmp[6]=0;
      stmp[7]=0;
# 628 "C:/Users/Jason Wolin/Dropbox/My Hobbies/Electric Car/RealDash_CAN_2way/RealDash_CAN_2way.ino"
...
# 723 "C:/Users/Jason Wolin/Dropbox/My Hobbies/Electric Car/RealDash_CAN_2way/RealDash_CAN_2way.ino"
    }
...
# 745 "C:/Users/Jason Wolin/Dropbox/My Hobbies/Electric Car/RealDash_CAN_2way/RealDash_CAN_2way.ino"
...
int i;
    ...
    Wire.endTransmission();
    delay(400);
    Wire.requestFrom(SLAVE_ADDRESS,38);
    i=0;
