...
char BsReturnString[37]; // string for i2C "BS" command
...
// test for valid commands
  ...
  if (strcmp(CmdPtr, "BS") == 0) { // bms cell is on status
   /* for(int x=0; x <= 11; x++){
      if(DwDccbits_IC0[x] == 1) Serial.print("1"); else Serial.print("0");
    }
    for(int x=1; x <= 6; x++){
      if(DwDccbits_IC0B[x] == 1) Serial.print("1"); else Serial.print("0");
    }
    for(int x=0; x <= 11; x++){
      if(DwDccbits_IC1[x] == 1) Serial.print("1"); else Serial.print("0");
    }
    for(int x=1; x <= 6; x++){
      if(DwDccbits_IC1B[x] == 1) Serial.print("1"); else Serial.print("0");
    }
    ...
    for(int x=1; x <= 6; x++){
      if(DwDccbits_IC0B[x] == 1) BsReturnString[12+x]='1'; else BsReturnString[12+x]='0';
    }
    for(int x=0; x <= 11; x++){
       if(DwDccbits_IC1[x] == 1) BsReturnString[18+x]='1'; else BsReturnString[18+x]='0';
    }
    for(int x=1; x <= 6; x++){
      if(DwDccbits_IC1B[x] == 1) BsReturnString[30+x]='1'; else BsReturnString[30+x]='0';
    }
    BsReturnString[36]=0; // end of string delimiter
  }
